...
var KonvaRenderer = ReactFiberReconciler({
  ...
  createTextInstance: function createTextInstance(text, rootContainerInstance, internalInstanceHandle, rest) {
    var NodeClass = Konva['Text'];

    var instance = new NodeClass();
    instance._applyProps = applyNodeProps;
    instance._applyProps(instance, {});
